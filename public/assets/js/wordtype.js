...
const list = [
  'Aggregation','Alert','Algol','Algorithm','Allocate','Ambient-Occlusion',
  'AOP','API','APK','Applet','Argument','Arithmetic-operator','Array','ASCII','ASP','ASPI',
  'Assembler', 'Assembly', 'Associative', 'AutoHotkey', 'Automated', 'Automation',
